...
namespace NetcodePlus
{
    ...
    public class NetworkMessaging
    {
        ...
        public NetworkMessaging(TheNetwork network)
        {
        ...
        //Previous version function names
        public void SendBuffer(string type, ulong target, FastBufferWriter writer, NetworkDelivery delivery) => Send(type, target, writer, delivery);
        public void SendBufferAll(string type, FastBufferWriter writer, NetworkDelivery delivery) => SendAll(type, writer, delivery);
